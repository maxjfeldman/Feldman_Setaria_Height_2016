...
def main():
  ...
  # Define ROI
  device, roi1, roi_hierarchy= pcv.define_roi(masked2,'rectangle', device, None, 'default', args.debug,True, 650, 10,-510,-415)
  ...
  device, shape_header,shape_data,shape_img = pcv.analyze_object_MF(img, args.image, obj, mask, 405, device,args.debug,outfile)
