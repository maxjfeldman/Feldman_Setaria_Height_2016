...
def main():
  ...
  # Define ROI
  device, roi1, roi_hierarchy= pcv.define_roi(masked2,'rectangle', device, None, 'default', args.debug,True, 525, 0,-490,-380)
  ...
  device, shape_header,shape_data,shape_img = pcv.analyze_object_MF(img, args.image, obj, mask, 330, device,args.debug,outfile)
