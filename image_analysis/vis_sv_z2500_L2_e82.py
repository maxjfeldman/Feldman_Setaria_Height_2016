...
def main():
  ...
  # Define ROI
  #device, roi1, roi_hierarchy= pcv.define_roi(masked2,'rectangle', device, None, 'default', args.debug,True, 550, 0,-590,-925)
  device, roi1, roi_hierarchy= pcv.define_roi(masked2,'rectangle', device, None, 'default', args.debug,True, 550, 0,-590,-940)
  ...
  device, shape_header,shape_data,shape_img = pcv.analyze_object_MF(img, args.image, obj, mask, 900, device,args.debug,outfile)
